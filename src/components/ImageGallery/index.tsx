...
const ImageGallery: Component<ImageGalleryProps> = (props) => {
  ...
  return (
    <div
      ...
      class={`fixed left-0 top-8 bottom-0 w-64 bg-black/80 backdrop-blur-md border-r border-white/10 transform transition-transform duration-300 z-40 ${
    ...
    >
      ...
      <div class="flex items-center justify-between p-2 border-b border-white/10">
        ...
        <button
          ...
          class="text-white/70 hover:text-white transition-colors duration-150 p-1 rounded hover:bg-white/10"
          aria-label="閉じる"
        >
          <svg
            width="16"
          ...
          {(imagePath) => (
            ...
            >
              ...
              <img
                ...
                class="w-full aspect-video object-cover bg-black/50"
                alt={getFileName(imagePath)}
                loading="lazy"
              />
              {/* ファイル名 */}
              <div class="p-1.5 bg-black/50 text-white/80 text-xs truncate">
